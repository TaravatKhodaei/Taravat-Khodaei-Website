...
subtitle: "Mainly focusing of Severe housing Issues impact on Life Expectancy"
author: "Taravat Khodaei"
...
This report consists of the selection of variables, data cleaning, imputation, exploratory data analysis, data partitioning, modeling, and assessment steps. Please refer to the main qmd file for acess to the full analysis. You can see selected results in the dashbord section. 
The ultimate goal is to investigate how key predictors, including severe housing problems, relate to life expectancy.
...
Life expectancy is chosen as the outcome variable because it is a central measure of overall population health. It contains more than 15 unique values, meeting the required criteria.
...
1.  **Physical Inactivity (quantitative)**: Percentage of adults reporting no physical activity.

2.  **Income Inequality (quantitative)**: A measure of socioeconomic disparity.

3.  **Air Pollution (quantitative)**: Level of fine particulate matter (PM2.5).

4.  **Social Associations (quantitative)**: Number of membership associations per 10,000 population.

5.  **Preventable Hospital Stays (quantitative)**: Rate of hospital stays preventable with effective outpatient care.
